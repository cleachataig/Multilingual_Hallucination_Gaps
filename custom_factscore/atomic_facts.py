...
class AtomicFactGenerator(object):
    def __init__(self, model=None, demon_dir=".cache/factscore/demos"):
    ...
    def get_init_atomic_facts_from_sentence(self, sentences, cost_estimate=None):
        ...
        if cost_estimate:
            ...
            for prompt in prompts:
                if cost_estimate == "consider_cache" and (prompt.strip() + "_0") in self.model.cache_dict:
                    continue
            ...
            for i, prompt in enumerate(prompts):
                ...
                output = self.model.generate(_ques)
